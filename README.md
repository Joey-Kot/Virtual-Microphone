...
GitHub Release 提供 `Virtual-Microphone-Latest.zip` 和同名 `.sha256` 校验文件。ZIP 包含程序、同源源码构建的 RNNoise VST2 DLL、示例配置、手动重启脚本、`LICENSE`、`NOTICE`、`THIRD_PARTY_NOTICES.md` 与 `THIRD_PARTY_LICENSES/` 中的完整第三方许可证文本。
